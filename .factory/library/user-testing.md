...
- `scripts/parity/run_matrix.py` has CLI groups `cli-formatting`, `cli-exit-errors`, and `cli-count-stream`; `VAL-CLI-001..003` can now be validated via `--group cli-count-stream` run_matrix artifacts.
